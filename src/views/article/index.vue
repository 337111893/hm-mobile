...
export default {
  ...
  methods: {
    ...
    async getArticleInfo () {
      ...
      const { artId } = this.$route.query // 从路由信息中读取query参数
    ...
    async follow () {
      ...
      // 未关注 => 关注
        ...
        this.$ynotify({ type: 'success', message: '操作成功' })
      } catch (error) {
        // 失败会进入到catch
        ...
        // 无论你写的执行时成功还是失败，无论走try还是catch最终都会进入finally
